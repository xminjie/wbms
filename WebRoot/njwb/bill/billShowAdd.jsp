			...
			<form action="billAdd.action" method="post">
				...
				<table id="empEditTable">
					...
					<tr>
						...
						<td>
							<input type="text" name="billCnt" id="billCnt" />
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<textarea rows="5" cols="40" name="billDetail"></textarea>
						</td>
					</tr>
					<tr>
					<tr>
						...
						<td>
							草稿<input type="radio"  name = "billStatus"  value = "-1"><br>
							正式提交<input type="radio"  name = "billStatus"  value = "1">
						</td>
					</tr>
					<tr>
