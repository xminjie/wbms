		...
		<div id="mainDiv">
			...
			<div id="contentDiv">
				<div id="content-left" class="lft">
					<ul>
						<c:forEach items="${menuList}" var="faMenu">
							<li class="menu">
								<span>${faMenu.menuName}</span>
								<ul class="hide">
									<c:forEach items="${faMenu.sonMenu}" var="son">
										<li class="menu-sub">
											<a href="${son.menuHrefUrl}" target="contentPage">
												${son.menuName} </a>
										</li>
									</c:forEach>
								</ul>
						...
						<%--	    					<li class="menu-sub"><a href="expense/expenseReport.html"  id="deptManager"   target="contentPage">报销统计</a></li>--%>
						<%--	    				</ul>--%>
						<%--	    			--%>
						<%--	    			</li>	    			--%>
						<%--	    		    <li class="menu">--%>
						...
						<%--	    					<li class="menu-sub">--%>
						<%--	    						<a href="permissions/permissionsList.html"  id="deptManager"   target="contentPage">--%>
						<%--	    							权限管理--%>
						<%--	    						</a>--%>
						<%--	    					</li>--%>
						<%--	    					<li class="menu-sub">密码重置</li>--%>
						<%--	    					<li class="menu-sub">系统退出</li>--%>
						<%--	    				</ul>--%>
						<%--	    			--%>
						<%--	    			</li>--%>
				...
				<div id="content-right" class="rft">
					<iframe src="" name="contentPage" scrolling="yes" frameborder="0"
